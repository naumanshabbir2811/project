...
export default function Hotel() {
  const [hotelData] = useHotelDataContext();
            ...
            return (
              <div className="hotelWrapper">
                ...
                <span className="hotelPriceHighlight">
                  Book and Stay in just Rs-10000 and get a free Taxi to the
                  Airport
                </span>
                ...
                <div className="hotelDetails">
                  <div className="hotelDetailsTexts">
                    ...
                    <p className="hotelDesc">
                      ...
                      deserunt maiores asperiores ipsa ut debitis dicta, vero
                      magni cum hic quo pariatur accusantium quas sunt ipsam
                      eaque neque at tempora? Tempore et qui laborum reiciendis
                      error fuga saepe eos molestias labore accusamus blanditiis
                      unde quos nobis, illum assumenda architecto aperiam
                      facilis animi explicabo nisi provident quaerat numquam
                      illo. Autem obcaecati libero voluptatum ratione.
                    </p>
                  </div>
                  <div className="hoteldetailsPrice">
                    <h1>Perfect for Honey Moon </h1>
                    <span>
                      located at the Heart of Lahore -- this place has the
                      history of Lahore in it
                    </span>
                    <h2>
                      <b>Rs-70000</b>
                      (7-Nights)
